...
object ThemeManager {
    ...
    val THEME_COLORS = listOf(
        ...
        intArrayOf(0xFFFFF8E1.toInt(), 0xFFFFECB3.toInt()),  // 黄色浅渐变
        intArrayOf(0xFFE0F7FA.toInt(), 0xFFB2EBF2.toInt()),  // 青色浅渐变
        intArrayOf(0xFFFCE4EC.toInt(), 0xFFF8BBD9.toInt())   // 粉色浅渐变
    )
